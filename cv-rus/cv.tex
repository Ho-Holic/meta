...
\usepackage[russian]{babel}
 ...
 % найти резюме если оно лежит в стопке других
...
% или QR code со ссылкой на актуальное резюме, профиль гугл плюс или rick roll (=
...
\subsection{Проект}
Unix/Scripting \textbullet{} Git \textbullet{} XSL \\
...
\vspace{\topsep} % !!! хак убирает глюк с наезжанием пунктов на заголовок !!!
\begin{tightitemize}
